...
function adicionarLinha() {
  ...
  tr.innerHTML = `
        ...
        <td><input type="text" class="qtd" value="0"></td>
        <td><input type="text" class="valor" value="0" step="0.01"></td>
...
function calcularTabela() {
  ...
  linhas.forEach((linha) => {
    ...
    linha.querySelector(".totalItem").innerText = totalItem.toLocaleString(
      "pt-BR",
      {
        style: "currency",
        currency: "BRL",
  ...
  document.getElementById("totalGeral").innerText = totalGeral.toLocaleString(
    "pt-BR",
